 ...
 */
public class Final_Balance implements Initializable,ControlledScreen {
...
//lkl
    ...
    void changeScene(ActionEvent event) {
        ...
        switch (((JFXButton) event.getSource()).getId()) {
            case "FinanceMainBtn":
                ScreenController.changeScreen(controller, FinanceScreens.FINALBALANCE_SCREEN, FinanceScreens.FINANCE_MAIN_SCREEN);
                break;
            // case "":
            //  break;
        }
